...
//        try (ObjectInputStream ois = new ObjectInputStream(new FileInputStream(TODO_FILE))) {
//            Object obj = ois.readObject();
//            if (obj instanceof Map) {
//                todoMap = (Map<Integer, String>) obj;
//                updateCalendar();
//            } else {
//
//                System.err.println("Failed to load todoMap: Unexpected data type");
//            }
...
//        try (ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream(TODO_FILE))) {
//            oos.writeObject(todoMap);
//        } catch (IOException e) {
//
//            e.printStackTrace();
//        }
