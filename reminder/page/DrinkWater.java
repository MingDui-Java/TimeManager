...
public class DrinkWater extends JPanel{
    private static DrinkWater instance = null;
    LocalDate ld;
    int hourSet = 0;
    int minSet = 0;
    int secondSet = 0;
    ...
    private DrinkWater() { }
    public static DrinkWater getInstance() {
        if (instance == null) {
            instance = new DrinkWater();
        }
        return instance;
    }
    public JPanel initialize() throws Exception {
        ...
        jm1.setMnemonic('s'); jm2.setMnemonic('d'); jb3.setMnemonic('i');
