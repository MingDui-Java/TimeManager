 ...
 * 当用户点击添加按钮时，将显示一个对话框来添加新的待办事项。 同时，该类也包含了 StartButtonListener 和
 * FinishButtonListener 内部类。
 *
 * @author 杨智方
 * @version 1.0
 */
...
class AddButtonListener implements ActionListener, Serializable {
	 ...
	 * 预定义的颜色
	 */
	public static Color[] predefinedColors = { new Color(72, 61, 139), new Color(255, 192, 203),
			new Color(173, 216, 230), new Color(78, 152, 217), new Color(128, 128, 128), new Color(119, 136, 153),
			new Color(47, 79, 79), new Color(199, 237, 204), };
}
