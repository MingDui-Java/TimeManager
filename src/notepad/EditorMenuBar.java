...
public class EditorMenuBar extends JMenuBar {
	...
	public void showColor() {
		if (colorDialog == null) {
			colorDialog = new JDialog(parentFrame, "Color", false);
			colorDialog.setLayout(new FlowLayout());
			colorDialog.add(new JLabel("Background Color:"));
			...
			JButton backgroundButton = new JButton("Change");
			backgroundButton.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					Color selectedColor = JColorChooser.showDialog(parentFrame, "Choose Background Color",
			...
			colorDialog.add(new JLabel("Foreground Color:"));
			...
			JButton foregroundButton = new JButton("Change");
			foregroundButton.addActionListener(new ActionListener() {
				@Override
				public void actionPerformed(ActionEvent e) {
					Color selectedColor = JColorChooser.showDialog(parentFrame, "Choose foreground Color",
